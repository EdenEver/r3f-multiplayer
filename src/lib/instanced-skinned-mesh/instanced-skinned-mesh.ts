...
export class InstancedSkinnedMesh extends SkinnedMesh {
  ...
  constructor(geometry: THREE.BufferGeometry, material: THREE.Material, count = 1) {
    ...
    this.bind = function (skeleton, bindMatrix) {
      ...
      // @ts-expect-error do: augment types
  ...
  copy(source: InstancedSkinnedMesh) {
    ...
    if (source.isInstancedMesh) {
      ...
      if (source.instanceColor !== null) {
        // @ts-expect-error do: this might be an actual error - investigate
